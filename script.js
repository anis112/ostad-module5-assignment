...
let basic_room_caption = "1 room";
let pro_room_caption = "1 room";

if (basic_counter == 0) {
    document.getElementById("basic-total-price").innerHTML = basic_package_base_price;
    document.getElementById("basic-room-info").innerHTML = basic_room_caption;
    basic_counter++;
}

if (pro_counter == 0) {
    document.getElementById("pro-total-price").innerHTML = pro_package_base_price;
    document.getElementById("pro-room-info").innerHTML = pro_room_caption;
    pro_counter++;
}
